...
L'objectif pédagogique est de couvrir toutes les étapes d'un travail de cartographie à partir de données géohistoriques -ici la feuille n°52 de la carte de Cassini, datant du 18e siècle- en utilisant uniquement les outils graphiques offerts par QGIS.
